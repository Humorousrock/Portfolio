            ...
            <div className={classes.carousel_container} id="start">
                ...
                <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay showStatus={false} showThumbs={false} >
                    <div className={classes.image_container} >
                        <img className={classes.image} src={Hello} alt="#" />
                        <div className={classes.h1}>
                            <h1 >I'm Aman</h1>
                            <a href="https://docs.google.com/document/d/1adiYd_K8jBVd2pt1_zoh6xuEhieWT2RmCWp9QojI7DU/edit" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown /></a>
                        </div>
                    </div>
                    <div className={classes.image_container}>
                        ...
                        <div className={classes.h2}>
                            ...
                            <h1>THINGS!!</h1>
                            <a href="https://github.com/Humorousrock" rel="opener noreferrer" target="_blank">   <GoProject /></a>
                        </div>
                    </div>
                    {/* <div className={classes.image_container}>
