                                    ...
                                    <div className={classes.timeline_centered}>
                                        ...
                                        <ScrollAnimation offset={0} animateIn="fadeInLeft" duration={2.4} animateOnce={true} initiallyVisible={true}>
                                            <article className={classes.timeline_entry}>
                                                ...
                                                <div className={classes.label}>
                                                    ...
                                                    <p>I have completed my higher education from JP Academy with major subjects as Physics,Chemistry & Maths with 75% in CBSE board. </p>
                                                </div>
                                            </article>
                                        </ScrollAnimation>
                                        ...
                                        <ScrollAnimation offset={0} animateIn="fadeInLeft" duration={2.4} animateOnce={true} initiallyVisible={true}>
                                            <article>
                                                ...
                                                <div className={classes.label}>
                                                    <h2 >Internship</h2>
                                                    <p>Completed 3 month Internship in Highradius Company where i work with front-end tools like HTML,CSS and Javascript</p>
                                                </div>
